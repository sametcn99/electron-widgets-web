...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center gap-10 p-6 pt-28">
      ...
      <Link
        href={
          "https://github.com/sametcn99/electron-widgets/releases/download/2.0.2/electron-widgets-2.0.2.Setup.exe"
        }
        className="gap-2  rounded-lg  p-2 text-center font-bold text-white hover:underline"
      >
        🎉 Download 2.0.2 Release <p className="font-thin">(Windows for now)</p>
      </Link>
